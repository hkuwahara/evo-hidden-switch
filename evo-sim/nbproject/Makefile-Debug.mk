...
${OBJECTDIR}/src/uniformly_distributed_random_generator.o: src/uniformly_distributed_random_generator.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/uniformly_distributed_random_generator.o src/uniformly_distributed_random_generator.c

${OBJECTDIR}/src/hash_table.o: src/hash_table.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hash_table.o src/hash_table.c

${OBJECTDIR}/src/strconv.o: src/strconv.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/strconv.o src/strconv.c
...
${OBJECTDIR}/src/options.o: src/options.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/options.o src/options.c

${OBJECTDIR}/src/bug.o: src/bug.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/bug.o src/bug.c

${OBJECTDIR}/src/log.o: src/log.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/log.o src/log.c

${OBJECTDIR}/src/normally_distributed_random_generator.o: src/normally_distributed_random_generator.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/normally_distributed_random_generator.o src/normally_distributed_random_generator.c

${OBJECTDIR}/src/vector.o: src/vector.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/vector.o src/vector.c

${OBJECTDIR}/src/environment.o: src/environment.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/environment.o src/environment.c

${OBJECTDIR}/src/exponentially_distributed_random_generator.o: src/exponentially_distributed_random_generator.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exponentially_distributed_random_generator.o src/exponentially_distributed_random_generator.c

${OBJECTDIR}/src/random_number_generator.o: src/random_number_generator.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/random_number_generator.o src/random_number_generator.c

${OBJECTDIR}/src/util.o: src/util.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/util.o src/util.c

${OBJECTDIR}/src/linked_list.o: src/linked_list.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/linked_list.o src/linked_list.c

${OBJECTDIR}/src/evolution.o: src/evolution.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/evolution.o src/evolution.c

${OBJECTDIR}/src/uniformly_distributed_discrete_random_generator.o: src/uniformly_distributed_discrete_random_generator.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/uniformly_distributed_discrete_random_generator.o src/uniformly_distributed_discrete_random_generator.c
